 ...
 * {@link org.junit.runner.Description} will be of a single test. However, if
 * problems are encountered while constructing the test (for example, if a
 * {@link org.junit.BeforeClass} method is not static), it may describe
...
public class Failure implements Serializable {
     ...
     *
     * @param description
     *            a {@link org.junit.runner.Description} of the test that failed
    ...
    /**
     * Gets a the printed form of the exception, with a trimmed version of the
     * stack trace. This method will attempt to filter out frames of the stack
     * trace that are below the test method call.
     */
