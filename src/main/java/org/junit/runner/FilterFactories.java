...
class FilterFactories {
     ...
     */
    public static Filter createFilterFromFilterSpec(Request request,
            String filterSpec) throws FilterFactory.FilterNotCreatedException {
        ...
        return createFilter(tuple[0],
                new FilterFactoryParams(topLevelDescription, tuple[1]));
    }
     ...
     */
    public static Filter createFilter(String filterFactoryFqcn,
    ...
    static FilterFactory createFilterFactory(String filterFactoryFqcn)
