 ...
 * provides a general filtering mechanism. If you want to filter the tests to be
 * run, extend <code>Filter</code> and apply an instance of your filter to the
 * {@link org.junit.runner.Request} before running it (see
 * {@link org.junit.runner.JUnitCore#run(Request)}. Alternatively, apply a
 * <code>Filter</code> to a {@link org.junit.runner.Runner} before running tests
 * (for example, in conjunction with {@link org.junit.runner.RunWith}.
 *
 * @since 4.0
 */
public abstract class Filter {
    ...
    public static Filter matchMethodDescription(
            final Description desiredDescription) {
        return new Filter() {
            @Override
            public boolean shouldRun(Description description) {
