...
/**
 * Convenience import class: these are useful matchers for use with the
 * assertThat method, but they are not currently included in the basic
...
public class JUnitMatchers {
    ...
    /**
     * @return A matcher matching any collection containing an element matching
     *         elementMatcher
    ...
    /**
     * @return A matcher matching any collection containing every element in
     *         elements
    ...
    /**
     * @return A matcher matching any collection containing at least one element
     *         that matches each matcher in elementMatcher (this may be one
     *         element matching all matchers, or different elements matching
     *         each matcher)
    ...
    /**
     * @return A matcher matching any collection in which every element matches
     *         elementMatcher
     * @deprecated Please use {@link CoreMatchers#everyItem(Matcher)} instead.
     */
    @Deprecated
    public static <T> Matcher<Iterable<T>> everyItem(
            final Matcher<T> elementMatcher) {
        return CoreMatchers.everyItem(elementMatcher);
    }

    /**
     * @return a matcher matching any string that contains substring
     * @deprecated Please use {@link CoreMatchers#containsString(String)}
     *             instead.
     */
    @Deprecated
    public static Matcher<java.lang.String> containsString(
     ...
     */
    @Deprecated
    public static <T> CombinableBothMatcher<T> both(
     ...
     */
    @Deprecated
    public static <T> CombinableEitherMatcher<T> either(
            Matcher<? super T> matcher) {
     ...
     *         appends the stacktrace of the actual Throwable in case of a
     *         mismatch.
     */
