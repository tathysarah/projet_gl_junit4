...
/**
 * The Stopwatch Rule notifies one of its own protected methods of the time
 * spent by a test.
 *
 * <p>
 * Override them to get the time in nanoseconds. For example, this class will
 * keep logging the time spent by each passed, failed, skipped, and finished
 * test:
 *
 * <pre>
