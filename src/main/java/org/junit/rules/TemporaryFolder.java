...
public class TemporaryFolder extends ExternalResource {
    ...
    private static File createTemporaryFolderIn(File parentFolder)
            throws IOException {
        try {
            ...
            IOException exception = new IOException(
                    "Failed to create temporary folder in " + parentFolder);
            exception.initCause(cause);
            throw exception;
        } catch (Exception e) {
            throw new RuntimeException(
                    "Failed to create temporary folder in " + parentFolder, e);
        }
    }
