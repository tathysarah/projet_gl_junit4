 ...
 * affect your existing tests (see {@code throwsNothing()}). After specifying
 ...
 *
 * <p>
 * This rule does not perform any special magic to make execution continue as if
 * the exception had not been thrown. So it is nearly always a mistake for a
 * test method to have statements after the one that is expected to throw the
 * exception.
 *
 * <p>
 * Instead of specifying the exception's type you can characterize the expected
 * exception based on other criteria, too:
 *
 * <ul>
...
public class ExpectedException implements TestRule {
     ...
     *             Assert.assertThrows} can be used to verify that your code
     ...
     * will fail with the error message "Test doesn't throw an instance of
     * foo.".
     *
     * @param message
