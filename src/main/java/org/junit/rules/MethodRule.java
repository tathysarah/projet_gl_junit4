 ...
 * {@link Statement}, which is passed to the next {@link Rule}, if any. For an
 * example of how this can be useful, see {@link TestWatchman}.
 *
 * <p>
 * Note that {@link MethodRule} has been replaced by {@link TestRule}, which has
 * the added benefit of supporting class rules.
 *
 * @since 4.7
 */
public interface MethodRule {
     ...
     * @param target
     *            The object on which the method will be run.
