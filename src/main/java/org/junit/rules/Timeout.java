...
public class Timeout implements TestRule {
    ...
    /**
     * Create a {@code Timeout} instance initialized with values from a builder.
     *
     * @since 4.12
     */
    ...
    /**
     * Creates a {@link Timeout} that will timeout a test after the given
    ...
    /**
     * Gets whether this {@code Timeout} will look for a stuck thread when the
     * test times out.
     *
     * @since 4.12
     */
     ...
     * and timeout the operation based on the values configured in this rule.
    ...
    protected Statement createFailOnTimeoutStatement(Statement statement)
            throws Exception {
        return FailOnTimeout.builder().withTimeout(timeout, timeUnit)
                .withLookingForStuckThread(lookForStuckThread).build(statement);
    }
        ...
        try {
            ...
            return new Statement() {
                ...
                public void evaluate() throws Throwable {
                    throw new RuntimeException("Invalid parameters for Timeout",
                            e);
                }
            };
        }
    ...
    public static class Builder {
         ...
         * {@code 0}, the returned {@code Timeout} rule instance will cause the
         * tests to wait forever to complete, however the tests will still
         * launch from a separate thread. This can be useful for disabling
         * timeouts in environments where they are dynamically set based on some
         * property.
         *
         * @param timeout
         ...
         * this feature is enabled, the rule will look for a thread that appears
