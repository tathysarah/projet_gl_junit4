...
public class AssumptionViolatedException extends RuntimeException
    ...
    /**
     * An assumption exception with the given <i>value</i> (String or Throwable)
     * and an additional failing {@link Matcher}.
     *
     * @deprecated Please use {@link org.junit.AssumptionViolatedException}
     *             instead.
     */
    ...
    /**
     * Override default Java object serialization to correctly deal with
     * potentially unserializable matchers or values. By not implementing
     * readObject, we assure ourselves of backwards compatibility and
     * compatibility with the standard way of Java serialization.
     *
     * @param objectOutputStream
     *            The outputStream to write our representation to
     * @throws IOException
    ...
    private void writeObject(ObjectOutputStream objectOutputStream)
        ...
        putField.put("fMatcher",
                SerializableMatcherDescription.asSerializableMatcher(fMatcher));

        // We have to wrap the value inside a non-String class (instead of
        // serializing the String value directly) as
        // A Description will handle a String and non-String object differently
        // (1st is surrounded by '"' while the
        // latter will be surrounded by '<' '>'. Wrapping it makes sure that the
        // description of a serialized and
        // non-serialized instance produce the exact same description
        putField.put("fValue",
                SerializableValueDescription.asSerializableValue(fValue));
