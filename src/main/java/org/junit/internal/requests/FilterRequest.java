...
public final class FilterRequest extends Request {
     ...
     *
     * @param request
     *            a {@link Request} describing your Tests
     * @param filter
     *            {@link Filter} to apply to the Tests described in
     *            <code>request</code>
     */
    ...
    public Runner getRunner() {
        try {
            ...
            return new ErrorReportingRunner(Filter.class,
                    new Exception(
                            String.format("No tests found matching %s from %s",
                                    fFilter.describe(), request.toString())));
        }
    }
}