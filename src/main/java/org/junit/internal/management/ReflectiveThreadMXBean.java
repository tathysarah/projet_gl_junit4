...
final class ReflectiveThreadMXBean implements ThreadMXBean {
    ...
    private static final class Holder {
        ...
        static {
            ...
            try {
                Class<?> threadMXBeanClass = Classes
                        .getClass("java.lang.management.ThreadMXBean");
                threadCpuTime = threadMXBeanClass.getMethod("getThreadCpuTime",
                        long.class);
                threadCpuTimeSupported = threadMXBeanClass
                        .getMethod("isThreadCpuTimeSupported");
    ...
    public long getThreadCpuTime(long id) {
        if (Holder.getThreadCpuTimeMethod != null) {
            ...
            try {
                return (Long) Holder.getThreadCpuTimeMethod.invoke(threadMxBean,
                        id);
    ...
    public boolean isThreadCpuTimeSupported() {
        if (Holder.isThreadCpuTimeSupportedMethod != null) {
            try {
                return (Boolean) Holder.isThreadCpuTimeSupportedMethod
                        .invoke(threadMxBean);
            } catch (ClassCastException e) {
                // fallthrough
            } catch (IllegalAccessException e) {
