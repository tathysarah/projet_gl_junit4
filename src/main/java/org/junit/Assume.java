 ...
 * differently.
 * <p>
 * A good example of using assumptions is in
 * <a href="https://github.com/junit-team/junit4/wiki/Theories">Theories</a>
 * where they are needed to exclude certain datapoints that aren't suitable or
 * allowed for a certain test case.
 * </p>
 * Failed assumptions are usually not logged, because there may be many tests
 * that don't apply to certain configurations.
 *
 * <p>
 ...
 *
 * @see <a href=
 *      "https://github.com/junit-team/junit4/wiki/Theories">Theories</a>
 *
 * @since 4.4
 */
public class Assume {
     ...
     *
     * @param b
     *            If <code>false</code>, the method will attempt to stop the
     *            test and ignore it by throwing
    ...
    /**
     * If called with a {@code null} array or one or more {@code null} elements
     * in {@code objects}, the test will halt and be ignored.
     */
     ...
     * @see org.junit.matchers.JUnitMatchers
     */
    public static <T> void assumeThat(String message, T actual,
            Matcher<T> matcher) {
        if (!matcher.matches(actual)) {
    ...
    /**
     * Use to assume that an operation completes normally. If {@code e} is
