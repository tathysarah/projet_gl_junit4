...
public class TestTimedOutException extends Exception {
    ...
    /**
     * Creates exception with a standard message "test timed out after [timeout]
     * [timeUnit]"
     * 
     * @param timeout
     *            the amount of time passed before the test was interrupted
     * @param timeUnit
     *            the time unit for the timeout value
     */
    public TestTimedOutException(long timeout, TimeUnit timeUnit) {
        super(String.format("test timed out after %d %s", timeout,
