...
/**
 * Thrown by {@link org.junit.runner.Runner}s in case the class under test is
 * not valid.
 * <p>
...
public class InvalidTestClassError extends InitializationError {
    ...
    private static String createMessage(Class<?> testClass,
            List<Throwable> validationErrors) {
        StringBuilder sb = new StringBuilder();
        sb.append(
                String.format("Invalid test class '%s':", testClass.getName()));
        int i = 1;
