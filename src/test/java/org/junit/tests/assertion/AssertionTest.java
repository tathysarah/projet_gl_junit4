...
//  }
    ...
    public void arraysNotEqual() {
        assertArrayEqualsFailure(new Object[] { "right" },
                new Object[] { "wrong" },
    ...
    public void arraysNotEqualWithMessage() {
        assertArrayEqualsFailure("not equal", new Object[] { "right" },
                new Object[] { "wrong" },
    ...
    public void arraysDifferentLengthDifferingAtStartMessage() {
        assertArrayEqualsFailure("not equal", new Object[] { true },
    ...
    public void arraysDifferentLengthDifferingAtEndAndExpectedArrayLongerMessage() {
        assertArrayEqualsFailure("not equal", new Object[] { true, false },
                new Object[] { true },
    ...
    public void arraysElementsDiffer() {
        assertArrayEqualsFailure("not equal", new Object[] {
                "this is a very long string in the middle of an array" },
                new Object[] {
                        "this is another very long string in the middle of an array" },
    ...
    public void arraysDifferAtElement0withMessage() {
        assertArrayEqualsFailure("message", new Object[] { true },
                new Object[] { false },
    ...
    public void arraysDifferAtElement1withMessage() {
        assertArrayEqualsFailure("message", new Object[] { true, true },
                new Object[] { true, false },
    ...
    public void multiDimensionalArraysAreEqual() {
        assertArrayEquals((new Object[][] { { true, true }, { false, false } }),
    ...
    public void multiDimensionalArraysAreNotEqual() {
        assertArrayEqualsFailure("message",
                new Object[][] { { true, true }, { false, false } },
    ...
    public void primitiveArraysConvertedToStringCorrectly() {
        assertArrayEqualsFailure("not equal", new boolean[][] { {}, { true } },
                new boolean[][] { {} },
        ...
        assertArrayEqualsFailure("not equal", new int[][] { {}, { 23 } },
                new int[][] { {} },
    ...
    public void twoDimensionalArraysConvertedToStringCorrectly() {
        assertArrayEqualsFailure("not equal",
    ...
    private void assertArrayEqualsFailure(Object[] expecteds, Object[] actuals,
    ...
    private void assertArrayEqualsFailure(String message, Object[] expecteds,
            Object[] actuals, String expectedMessage) {
        try {
    ...
    public void notEqualsObjectWithNullWithMessage() {
        ...
        try {
            ...
            assertEquals(
                    "message expected:<null> but was:<" + o.toString() + ">",
                    e.getMessage());
            return;
        }
        throw new AssertionError(ASSERTION_ERROR_EXPECTED);
    ...
    public void notEqualsNullWithObjectWithMessage() {
        ...
        try {
            ...
            assertEquals(
                    "message expected:<" + o.toString() + "> but was:<null>",
                    e.getMessage());
            return;
        }
        throw new AssertionError(ASSERTION_ERROR_EXPECTED);
    ...
    public void nullAndStringNullPrintCorrectError() {
        try {
            ...
            assertEquals("expected: null<null> but was: java.lang.String<null>",
                    e.getMessage());
            return;
        }
        throw new AssertionError(ASSERTION_ERROR_EXPECTED);
    ...
    public void nullToString() {
        try {
            ...
            assertEquals(
                    "expected: org.junit.tests.assertion.AssertionTest$NullToString<null> but "
