...
public final class MultiCategoryTest {
    ...
    /**
     * This test is mentioned in {@code Categories} and any changes must be
     * reflected.
     */
    @Test
    public void runSuite() {
        ...
        assertThat("unexpected run count", testResult.getRunCount(),
                is(equalTo(2)));
        assertThat("unexpected failure count", testResult.getFailureCount(),
                is(equalTo(0)));
        assertThat("unexpected failure count", testResult.getIgnoreCount(),
                is(equalTo(0)));
    }
