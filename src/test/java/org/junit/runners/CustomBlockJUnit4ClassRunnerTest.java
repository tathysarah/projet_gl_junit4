...
public class CustomBlockJUnit4ClassRunnerTest {
    ...
    public void exceptionsFromMethodBlockMustNotResultInUnrootedTests()
        ...
        new CustomBlockJUnit4ClassRunner(
                CustomBlockJUnit4ClassRunnerTestCase.class).run(notifier);
    ...
    /**
     * Custom extension of {@link BlockJUnit4ClassRunner} that always throws an
     * exception from the {@code methodBlock()} if a test method is named
     * exactly {@code "throwException"}.
     */
    private static class CustomBlockJUnit4ClassRunner
            extends BlockJUnit4ClassRunner {

        CustomBlockJUnit4ClassRunner(Class<?> testClass)
        ...
        protected Statement methodBlock(FrameworkMethod method) {
            if ("throwException".equals(method.getName())) {
                throw new RuntimeException(
                        "throwException() test method invoked");
            }
    ...
    /**
     * Simple {@link RunListener} that tracks the number of times that certain
