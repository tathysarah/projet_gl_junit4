...
public class ComparisonFailureTest extends TestCase {
    ...
    public void testConnection() {
        ComparisonFailure failure = new ComparisonFailure("warning",
                "Mary had a little lamb", "Mary had the little lamb");
        assertEquals(
                "warning expected:<Mary had [a] little lamb> but was:<Mary had [the] little lamb>",
                failure.getMessage());
    }
    ...
    public void testExceptionToStringWithMessage() {
        try {
            ...
            if (!e.toString().startsWith(
                    "junit.framework.ComparisonFailure: woops! expected:<")) {
